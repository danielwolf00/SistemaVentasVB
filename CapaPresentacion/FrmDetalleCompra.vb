...
Namespace CapaPresentacion
    Public Partial Class FrmDetalleCompra
        Inherits Form
        Public Sub New()
            InitializeComponent()
        End Sub

        Private Sub txtfecha_TextChanged(ByVal sender As Object, ByVal e As EventArgs)

        End Sub

        Private Sub FrmDetalleCompra_Load(ByVal sender As Object, ByVal e As EventArgs)

        End Sub

        Private Sub btnbuscar_ClickMethod(ByVal sender As Object, ByVal e As EventArgs)
